...
## Summaries {.tabset .tabset-dropdown}
...
The estimated length of each zone at each site is shown below with reductions in sample effort.  Each line represents a unique zone.  Estimated zone lengths decrease slightly with reduced effort.  Zones with zero length only have one sample, where distance is calculated as the difference from the first sample point and last sample point in a zone. Points are sized by the variance of the estimates across the random subsamples at level of sample effort. 
